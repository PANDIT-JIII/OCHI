function Footer() {
  return (
    <div className="w-full h-screen p-20 flex gap-5 font-['Founders Grotesk']">
      ...
      <div className="w-1/2 h-full ">
        <h1 className="text-[6vw] font-bold leading-none -mb-5 uppercase tracking-tighter">
          presentations
        </h1>
        <div className="flex py-10">
          <div className="w-1/2 ">
            <h1 className="text-xl">S:</h1>
            <div className="dets font-['Neue Montreal'] mt-4">
              <a className="block text-lg font-light group transition duration-300" href="#">
                Instagram
                <span className="block max-w-0 group-hover:max-w-20 transition-all duration-500 h-[0.6px] bg-zinc-800"></span>
              </a>
              <a className="block text-lg font-light group transition duration-300" href="#">
                Behance
                <span className="block max-w-0 group-hover:max-w-20 transition-all duration-500 h-[0.6px] bg-zinc-800"></span>
            ...
            <h1 className="mt-8 text-xl">L:</h1>
            <div className="dets font-['Neue Montreal'] mt-4">
              <a className="block text-lg font-light group transition duration-300" href="#">
                202-1965W 4th Ave
                <span className="block max-w-0 group-hover:max-w-40 transition-all duration-500 h-[0.6px] bg-zinc-800"></span>
              </a>
              <a className="block text-lg font-light group transition duration-300" href="#">
                Vancouver,Canada
                <span className="block max-w-0 group-hover:max-w-40 transition-all duration-500 h-[0.6px] bg-zinc-800"></span>
              ...
              <div className="mt-4">
                <a className="block text-lg font-light group transition duration-300" href="#">
                  30 Chukarina St
                  <span className="block max-w-0 group-hover:max-w-32 transition-all duration-500 h-[0.6px] bg-zinc-800"></span>
                </a>
                <a className="block text-lg font-light group transition duration-300" href="#">
                  Lviv,Ukraine
                  <span className="block max-w-0 group-hover:max-w-24 transition-all duration-500 h-[0.6px] bg-zinc-800"></span>
                </a>
              </div>
            </div>
            <h1 className="mt-8 text-xl">E:</h1>
            <div className="dets font-['Neue Montreal'] mt-4">
              <a className="block text-lg font-light group transition duration-300" href="#">
                hello@ochi.design
                <span className="block max-w-0 group-hover:max-w-36 transition-all duration-500 h-[0.6px] bg-zinc-800"></span>
              </a>
              <a href="">
                <button className=" text-zinc-400 text-lg mt-8">
                  ochi design 2025.Legal Terms
                </button>
              </a>
            </div>
          </div>
          <div className="w-1/2 flex justify-center items-center flex-col mt-[8vw] ml-[5vw]">
            <h1 className="text-xl mr-[3.8vw]">M:</h1>
            <div className="dets font-['Neue Montreal'] mt-4">
              <a className="block text-lg font-light group transition duration-300" href="#">
                Home
                <span className="block max-w-0 group-hover:max-w-20 transition-all duration-500 h-[0.6px] bg-zinc-800"></span>
            ...
            <a href="">
              <button className=" text-zinc-400 text-lg mt-[10vw] ml-[3.8vw]">
                Website by Obys
              </button>
            </a>
          </div>
